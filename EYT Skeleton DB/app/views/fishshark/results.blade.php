...
<input type="hidden" name="game" value="fishshark" />
...
<table class="table table-bordered table-striped">
    <thead>
    <tr>
        <th colspan="2"><a class="btn btn-warning btn-xs btn-block" id="btnFishSharkCSV">CSV</a></th>
    ...
    @foreach ($games as $game)
        <tr id="row{{ $game->id }}">
            ...
            <td><button class="btnViewGame btn btn-primary btn-xs" data-game_id="{{$game->id}}" data-game_type="fishshark"><i class="glyphicon glyphicon-info-sign"></i></button></td>
...
<!-- 
 ...
 -->
            ...
            <td class="text-center"><a class="btn btn-danger btn-xs btnDeleteGame" data-last_id="{{ $lastID }}" data-game_id="{{ $game->id }}" data-game_type="fishshark" data-confirm="0"><i class="glyphicon glyphicon-trash"></i></a></td>

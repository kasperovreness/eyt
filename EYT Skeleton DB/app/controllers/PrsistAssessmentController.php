...
class PrsistAssessmentController extends Controller {
 ...
 //           $gameScore = 0;
    ...
    public function deleteGame($game_id)
    {
        ...
        if ($user->delete == 1) {
            PrsistAssessmentScore::where("game_id", "=", $game_id)->delete();
            PrsistAssessmentGame::where("id", "=", $game_id)->delete();
    ...
    public function deleteGames()
    {
        ...
        return $gameRep->deleteGames(new PrsistAssessmentScore(), $games);
    }

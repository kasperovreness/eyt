...
<div class="well">
    <div class="row">
        ...
        <div class="col-sm-3">
            <a class="btn btn-primary" id="btnEarlyNumFilter">Submit</a>
        </div>
    </div>
</div>
...
<table class="table table-bordered table-striped">
    <thead>
    <tr>
        <th colspan="2"><a class="btn btn-warning btn-xs btn-block" id="btnEarlyNumCSV">CSV</a></th>
    ...
    @foreach ($games as $game)
        <tr id="row{{ $game->id }}">
            ...
            <td><button class="btnViewGame btn btn-primary btn-xs" data-game_id="{{$game->id}}" data-game_type="early_numeracy"><i class="glyphicon glyphicon-info-sign"></i></button></td>

    ...
    <table class="table table-bordered table-striped">
        <tr>
            ...
            <td>
                ...
                <input type="text" name="child_id" value="{{$game->child_id}}" />
            </td>
            <td>
        ...
        <tr>
            <td>
                ...
                <input type="text" name="assessor" value="{{$game->assessor_name}}" />
            </td>
            <td>
                <label>D.O.B.</label><br/>
                <input type="text" name="dob" placeholder="yyyy-mm-dd" value="{{$game->dob}}" />
            </td>
            <td>
                <label>Age</label><br/>
        ...
        <tr>
            ...
            <td>
                <label>Room</label><br/>
                <input type="text" name="room" value="{{$game->room}}" />
            </td>

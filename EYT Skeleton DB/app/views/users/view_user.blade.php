...
<form id="frmUpdateUser">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <label>PRSIST Assessment Data:</label>
            <select class="form-control" name="prsistassessment">
                <option value="0" {{ ($user->prsistassessment == 0) ? "selected" : "" }}>DISABLED</option>
                <option value="1" {{ ($user->prsistassessment == 1) ? "selected" : "" }}>ENABLED</option>
            </select>
        </div>
    </div><br/>

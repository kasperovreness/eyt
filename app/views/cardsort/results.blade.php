...
<table class="table table-bordered table-striped">
    <thead>
    <tr>
        <th colspan="2"><a class="btn btn-warning btn-xs btn-block" id="btnCardSortCSV">CSV</a></th>
    ...
    @foreach ($games as $game)
        <tr id="row{{ $game->id }}">
            ...
            <td><button class="btnViewGame btn btn-primary btn-xs" data-game_id="{{$game->id}}" data-game_type="cardsort"><i class="glyphicon glyphicon-info-sign"></i></button></td>
